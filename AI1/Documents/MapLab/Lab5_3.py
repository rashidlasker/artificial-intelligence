...
def generateDictionaryOfNames():
    ...
    nodeFileName = 'E:/Documents/MapLab/rrNodeCity.txt'
    namesDict = dict()
...
def generateDictionaryOfLocations():
    ...
    nodeFileName = 'E:/Documents/MapLab/rrNodes.txt'
    locationDict = dict()
...
def generateDictionaryOfNeighbors():
    ...
    edgeFileName = 'E:/Documents/MapLab/rrEdges.txt'
    neighborDict = dict()
...
def saveDictIntoFile(inputDict,name):
    ...
    newFileName = 'E:/Documents/MapLab/' + name + '.txt'
    import pickle
