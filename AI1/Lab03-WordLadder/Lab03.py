""" +=========================================================================================+
    ...
    This program generates a word ladder between two words using the product of the previous lab and prints it out.
"""
...
def main():
    ...
    firstWord = getWord(neighborDict)
    print('Type in the second six-letter word: ')
    secondWord = getWord(neighborDict)
